...
<body>
 <!-- Navbar Start -->
    ...
    <section class="ty">
      ...
      <form name="submitemail" action="/emailvalidation" method="get" onsubmit="return validateForm()">
        <input class="email" type="email" id="email" name="email" value="${emailval}" /> <br />
        <br />  
        <input class="btn" type="submit" value="CONFIRM" /></a>
      </form>
    </section>
    <!-- footer -->
    ...
    <script>
      function validateForm() {
        if (document.forms['submitemail']['email'].value == '') {
          alert("Let's confirm your email address!");
