...
<jsp:include page="My-Header-In.jsp"></jsp:include>
    ...
    <div style="margin: 0 0 0 300px">
      <div class="container-xxl py-5">
        <div class="container">
          <i class="bi bi-arrow-left"> <a href="/viewcar" style="text-decoration: none">Display Other Vehicles</a><br /><br /></i>
          <div class="row g-5">
            <div class="col-lg-10 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <br>
              <div>
            <button type="button" id="submit" name="submit" class="btn btn-success"><a href="/viewcarbidding?carId=${car.carId}" style="color: white">Bidding List</a></button>
          </div>
            </div>
          </div>
        </div>
