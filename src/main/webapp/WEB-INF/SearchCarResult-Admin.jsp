 ...
 font-size:80px;
  ...
  <section class="page_404">
	<div class="container">
		...
		<a href="/viewcaradmin" class="link_404">Go Back </a>
	</div>
		</div>
		</div>
		</div>
...
<dd:if test="${not empty searchcar}"> 
 <button style="margin: 0 0 -20px 248px; height: 35px;" class="btn btn-secondary" ><a href="/searchcar-admin" class="text-white" stlye="text-decoration:none;">Back</a></button>
