...
<head>
	...
	<title>Verify Code - ABC Community Portal</title>
...
<body>
 <!-- Navbar Start -->
    ...
    <section class="fpemail">
      ...
      <br />
      <form name="submitcode" action="/forgotpassword" method="get" onsubmit="return validateForm()">
      <label for="codeval">Enter Code : </label><br />
      <input type="number" name="codeval" class="codeval" id="codeval" required /> <br />
      <br /><br />
    ...
    <script>
      function validateForm() {
        if (document.forms['submitcode']['codeval'].value == '') {
          alert('Please check your email and enter the validation code!');
          document.forms['submitcode']['codeval'].focus();
          return false;
        }
      }
    </script>
