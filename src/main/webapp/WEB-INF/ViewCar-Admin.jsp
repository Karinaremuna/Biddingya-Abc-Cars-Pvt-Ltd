...
<button style="margin: 0 0 -20px 248px; height: 35px;" class="btn btn-secondary" ><a href="/searchcar-admin" class="text-white" stlye="text-decoration:none;">Search for car</a></button>
 <!-- view job start -->
  <dd:forEach var="car" items="${viewcar}">
      <div>
        <div class="viewjob1" style="height: 250px">
          ...
          <div>
            <button type="button" id="submit" name="submit" class="btn btn-danger"><a href="/deleteCar/${car.carId}" style="color: white">Delete</a></button>
            <a style="margin: -120px 0 0 800px" href="/updateCar/${car.carId}" class="btn btn-primary">Update</a>
          </div>
        </div>
      </div>
    </dd:forEach>
